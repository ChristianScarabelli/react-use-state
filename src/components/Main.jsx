...
export default function Main() {
    ...
    const toggleCurrentLang = (id) => {
        setCurrentLang((currentLang) => (currentLang === id ? null : id))
    }
    return (
        <>
            <main>
                        ...
                        <div className='row'>
                            {
                                languages.map((language) =>
                                    <Button
                                        ...
                                        isActive={currentLang === language.id}
                                        callback={() => toggleCurrentLang(language.id)} // al click invoco la funzione che cambia l'id con quello del linguaggio corrente dell'array ciclato
                                    />
                                )
                            }
                        </div>
                ...
                <section className='card-section'>
                    <div className="container">
                        ...
                        <Card language={languages.find((lang) => lang.id === currentLang)}
                        />
                    </div>
                </section>
            </main>
